...
static int board_es8311_i2c_transfer(struct i2c_master_s *dev,
                                    struct i2c_msg_s *msgs, int count)
{
  struct es8311_i2c_proxy_s *proxy =
    (struct es8311_i2c_proxy_s *)dev;
...
int board_es8311_initialize(void)
{
  ...
  i2s = esp_i2sbus_initialize(
    CONFIG_ESP32P4_FUNCTION_EV_BOARD_ES8311_I2S_PORT);
  if (i2s == NULL)
    {
  ...
  i2c = esp_i2cbus_initialize(
    CONFIG_ESP32P4_FUNCTION_EV_BOARD_ES8311_I2C_PORT);
  if (i2c == NULL)
    {
  ...
  playback = es8311_initialize(&g_es8311_i2c_proxy.dev, i2s,
                               &g_es8311_lower[0]);
  if (playback == NULL)
    {
  ...
  capture = es8311_initialize(&g_es8311_i2c_proxy.dev, i2s,
                              &g_es8311_lower[1]);
  if (capture == NULL)
    {
