 ...
 * sc2336_720p30_raw10.h
 *
 * SPDX-FileCopyrightText: 2025 Espressif Systems (Shanghai) CO LTD
 * SPDX-License-Identifier: Apache-2.0
 *
 * Derived from esp-video-components:
 * sc2336_mipi_2lane_24Minput_1280x720_raw10_30fps.h
 ****************************************************************************/

#ifndef __BOARDS_RISCV_ESP32P4_ESP32P4_FUNCTION_EV_BOARD_SRC_SC2336_720P30_RAW10_H
#define __BOARDS_RISCV_ESP32P4_ESP32P4_FUNCTION_EV_BOARD_SRC_SC2336_720P30_RAW10_H

static const struct sc2336_reg_s g_sc2336_720p30_raw10[] =
{
  {0x0103, 0x01}, {0x0100, 0x00}, {0x36e9, 0x80}, {0x37f9, 0x80},
  {0x301f, 0x2e}, {0x3106, 0x05}, {0x3200, 0x01}, {0x3201, 0x34},
  {0x3202, 0x00}, {0x3203, 0xb4}, {0x3204, 0x06}, {0x3205, 0x53},
  {0x3206, 0x03}, {0x3207, 0x8b}, {0x3208, 0x05}, {0x3209, 0x00},
  {0x320a, 0x02}, {0x320b, 0xd0}, {0x320c, 0x07}, {0x320d, 0x08},
  {0x320e, 0x05}, {0x320f, 0xdc}, {0x3210, 0x00}, {0x3211, 0x10},
  {0x3212, 0x00}, {0x3213, 0x04}, {0x3248, 0x04}, {0x3249, 0x0b},
  ...
  {0x3393, 0x20}, {0x3394, 0x20}, {0x3395, 0x30}, {0x33a2, 0x04},
  ...
  {0x36ea, 0x09}, {0x36eb, 0x0c}, {0x36ec, 0x1c}, {0x36ed, 0x28},
  {0x3722, 0xe1}, {0x3724, 0x41}, {0x3725, 0xc1}, {0x3728, 0x20},
  {0x37fa, 0x09}, {0x37fb, 0x32}, {0x37fc, 0x11}, {0x37fd, 0x37},
  {0x3900, 0x0d}, {0x3905, 0x98}, {0x391b, 0x81}, {0x391c, 0x10},
  {0x3933, 0x81}, {0x3934, 0xc5}, {0x3940, 0x68}, {0x3941, 0x00},
  {0x3942, 0x01}, {0x3943, 0xc6}, {0x3952, 0x02}, {0x3953, 0x0f},
  {0x3e01, 0x37}, {0x3e02, 0xe0}, {0x3e08, 0x1f}, {0x3e1b, 0x14},
  {0x440e, 0x02}, {0x4509, 0x38}, {0x4819, 0x06}, {0x481b, 0x03},
  {0x481d, 0x0b}, {0x481f, 0x03}, {0x4821, 0x08}, {0x4823, 0x03},
...
#endif /* __BOARDS_RISCV_ESP32P4_ESP32P4_FUNCTION_EV_BOARD_SRC_SC2336_720P30_RAW10_H */
