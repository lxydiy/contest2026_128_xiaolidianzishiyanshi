...
include(${TOOLS_DIR}/espressif_esptool_common.cmake)
...
if(ESPTOOL
   AND PYTHON3
   AND EXISTS "${TOOLS_DIR}/check_esptool.py")
  execute_process(
    COMMAND ${PYTHON3} ${TOOLS_DIR}/check_esptool.py -v 4.8.0
...
if(CONFIG_ESPRESSIF_BOOTLOADER_MCUBOOT)
  ...
  message(STATUS "${IMGTOOL} sign ${IMGTOOL_SIGN_ARGS} ${BINARY_DIR}/nuttx.hex ${BINARY_DIR}/nuttx.bin")
